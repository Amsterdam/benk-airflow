...
from benk.common import BaseOperaterArgs, TEAM_NAME
from benk.environment import DGDialogEnvironment, GOBEnvironment, GenericEnvironment
from benk.workflow import Import

env_vars = GenericEnvironment().env_vars() + GOBEnvironment().env_vars() + DGDialogEnvironment().env_vars()
